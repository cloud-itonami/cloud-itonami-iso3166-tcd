(ns marketentry.marketentryllm
  ...
  the Chad (TCD) public-sector market-entry compliance actor.
...
(defn- propose-submit
  ...
  (let [e (store/engagement db subject)]
    {:summary    (str subject " 向けポータル提出提案"
                      (when e (str " (operator=" (:operator e) ")")))
     :rationale  (if e
                   (str "preference-claim=" (:preference-claim e)
                        " chadian-artisan-or-entrepreneur?=" (:chadian-artisan-or-entrepreneur? e)
                        " chadian-capital-majority-direct?=" (:chadian-capital-majority-direct? e)
                        " chadian-capital-majority-indirect?=" (:chadian-capital-majority-indirect? e)
                        " chadian-women-business?=" (:chadian-women-business? e)
                        " best-bid-price=" (:best-bid-price e)
                        " claimed-preferential-price=" (:claimed-preferential-price e)
                        " procurement-official-conflict?=" (:procurement-official-conflict? e)
                        " dgi-record-verified?=" (:dgi-record-verified? e)
     ...
     :confidence (if (and e
                          (not (:procurement-official-conflict? e))
                          (or (not (:requires-dgi-record? e))
                              (:dgi-record-verified? e)))
                   0.9 0.3)}))
